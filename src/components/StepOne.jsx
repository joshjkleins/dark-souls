function StepOne({choice}) {
    ...
    return(
        <div className="btn-group btn-group-vertical lg:btn-group-horizontal flex justify-center items-center h-screen pb-20">
            <button className="btn btn-disabled" onClick={() => choice('Dark Souls')}>Dark Souls</button>
            <button className="btn btn-disabled" onClick={() => choice('Dark Souls 2')}>Dark Souls 2</button>
